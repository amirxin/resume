...
📍 Madrid, Spain &nbsp;|&nbsp; 📧 amir.salous [at] gmail.com &nbsp;|&nbsp; 🔗 [linkedin.com/in/amirsalous-63019238](https://www.linkedin.com/in/amirsalous-63019238)
...
**Patterson UTI** &nbsp;·&nbsp; *Jan 2020 – Present* &nbsp;·&nbsp; Remote

- Developed and maintained **REST APIs** in **Java / Spring Boot** to track drilling rig operations and surface KPIs across the organization
- Integrated data from multiple heterogeneous sources including **InfluxDB, QuestDB, PostgreSQL, CSV files, and event streams** into unified processing pipelines
- Built standalone **Java processors** for file ingestion, data transformation, and automated report generation
- Part of a small distributed team delivering continuous feature development over 5+ years
...
**IECISA | Informática El Corte Inglés** &nbsp;·&nbsp; *Oct 2018 – Sep 2022* &nbsp;·&nbsp; Madrid, Spain  
*(Concurrent with Dawere — initially placed via Grupo CINTE, later hired directly)*

- Backend development and support for a **telecom portability platform** deployed across mobile operators in Colombia and Costa Rica
- Built a **REST API** for Costa Rica's telecommunications regulatory authority, consumed by a government mobile application
- Implemented a **cloned IMEI detection system** using **Apache Spark and Scala**, analyzing call logs to flag fraudulent device activity
- Led the team's migration from **SVN to Git**

---

### Earlier Experience *(2012 – 2015)*
Java developer roles across several firms in Caracas, Venezuela — building ERP modules, enterprise Java applications, and Oracle SQL backends across construction, finance, and services industries.
...
*Open to senior backend and software engineering roles in Madrid and remotely.*
